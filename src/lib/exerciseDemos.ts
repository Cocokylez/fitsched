...
export interface ExerciseDemo {
  ...
  startSvgFallbackAssetPath: string
  endSvgFallbackAssetPath: string
...
function demo(
  ...
  return {
    ...
    startAssetPath: `/assets/exercises/${slug}/start.webp`,
    endAssetPath: `/assets/exercises/${slug}/end.webp`,
    startFallbackAssetPath: `/assets/exercises/${slug}/start.png`,
    endFallbackAssetPath: `/assets/exercises/${slug}/end.png`,
    startSvgFallbackAssetPath: `/assets/exercises/${slug}/start.svg`,
    endSvgFallbackAssetPath: `/assets/exercises/${slug}/end.svg`,
...
export const EXERCISE_DEMOS: ExerciseDemo[] = [
  ...
  demo("Knee Push-ups", "A beginner push-up variation with less bodyweight load.", ["Set knees on the floor and hands under shoulders.", "Keep hips, ribs, and shoulders in one line.", "Lower with control and press back up."], ["Chest", "Triceps", "Shoulders"], "BEGINNER", "knees stay down while upper body lowers and presses up"),
  ...
  demo("Tempo Push-ups", "A slow push-up that builds control and tension.", ["Start in a high plank.", "Lower for three controlled counts.", "Press up smoothly without rushing."], ["Chest", "Triceps", "Core"], "INTERMEDIATE", "push-up lowers slowly then presses up with controlled tempo"),
  demo("Shoulder Tap Push-ups", "A push-up followed by alternating shoulder taps.", ["Perform one controlled push-up.", "At the top, tap one opposite shoulder.", "Repeat and switch sides while keeping hips steady."], ["Chest", "Triceps", "Core"], "INTERMEDIATE", "push-up then one hand taps opposite shoulder in plank"),
  ...
  demo("Dumbbell Floor Press", "A floor press that trains chest without a bench.", ["Lie on your back with knees bent.", "Start dumbbells above elbows on the floor.", "Press up, then lower elbows gently to the floor."], ["Chest", "Triceps"], "BEGINNER", "athlete lies on floor pressing dumbbells from elbows down to arms straight"),
  ...
  demo("Dumbbell Pullover", "A dumbbell arc that trains lats and chest control.", ["Lie back holding one dumbbell over your chest.", "Reach the weight behind your head with control.", "Pull it back over your chest without arching hard."], ["Lats", "Chest", "Core"], "INTERMEDIATE", "dumbbell moves in an arc from chest to behind head and back"),
  ...
  demo("Prone Y Raises", "A floor upper-back raise with arms in a Y shape.", ["Lie face down with arms overhead in a Y.", "Lift hands slightly while keeping neck neutral.", "Lower slowly without shrugging."], ["Upper Back", "Rear Shoulders"], "BEGINNER", "prone athlete lifts arms in a Y shape and lowers"),
  demo("Prone T Raises", "A floor rear-shoulder raise with arms wide.", ["Lie face down with arms out like a T.", "Lift hands and squeeze shoulder blades.", "Lower with control."], ["Rear Shoulders", "Upper Back"], "BEGINNER", "prone athlete lifts arms wide in a T shape and lowers"),
  demo("Reverse Snow Angels", "A prone shoulder sweep for upper-back control.", ["Lie face down with arms by your sides.", "Sweep arms overhead in a wide arc.", "Return to your sides while staying lifted."], ["Upper Back", "Shoulders"], "BEGINNER", "prone athlete sweeps arms from sides to overhead like snow angels"),
  demo("Towel Rows", "A home row variation using a towel and sturdy anchor.", ["Hold both towel ends with a safe anchor.", "Lean back with body straight.", "Pull chest toward the anchor and lower slowly."], ["Back", "Biceps"], "INTERMEDIATE", "athlete leans back and rows body toward a towel anchor"),
  ...
  demo("Arm Circles", "A light shoulder endurance drill.", ["Stand tall with arms out to the sides.", "Make small controlled circles.", "Reverse direction halfway through."], ["Shoulders"], "BEGINNER", "arms stay extended while making small forward and backward circles"),
  demo("Scapular Push-ups", "A straight-arm push-up for shoulder blade control.", ["Start in a high plank.", "Let shoulder blades move together slightly.", "Push the floor away to spread them apart."], ["Shoulders", "Upper Back", "Core"], "BEGINNER", "straight arm plank with shoulder blades sinking and pushing apart"),
  demo("Wall Handstand Hold", "A wall-supported inverted shoulder hold.", ["Place feet on the wall carefully.", "Stack shoulders over hands.", "Hold a firm line and step down safely."], ["Shoulders", "Core"], "ADVANCED", "athlete holds a handstand position with feet supported on wall"),
  ...
  demo("Chair Dips", "A beginner home triceps dip using a chair.", ["Place hands on a stable chair behind you.", "Keep feet planted and chest lifted.", "Bend elbows, then press back up."], ["Triceps", "Shoulders"], "BEGINNER", "hands on chair behind body while elbows bend and extend"),
  ...
  demo("Plank Up-Downs", "A plank drill that trains arms, shoulders, and core.", ["Start in a forearm plank.", "Press one hand then the other into high plank.", "Lower back to forearms and alternate lead arms."], ["Arms", "Shoulders", "Core"], "INTERMEDIATE", "forearm plank transitions to high plank and back down"),
  ...
  demo("Reverse Lunges", "A backward lunge that is friendly for balance and knees.", ["Step one foot backward.", "Lower until both knees bend.", "Drive through the front foot to return."], ["Quads", "Glutes", "Hamstrings"], "BEGINNER", "athlete steps backward into a lunge then returns to standing"),
  demo("Split Squats", "A stationary lunge pattern for single-leg strength.", ["Set a staggered stance.", "Lower straight down with torso tall.", "Stand through the front foot."], ["Quads", "Glutes"], "INTERMEDIATE", "stationary split stance lowers and rises without stepping"),
  demo("Side Lunges", "A lateral lunge for hips, glutes, and inner thighs.", ["Step wide to one side.", "Sit hips back over the stepping leg.", "Push back to the center and switch."], ["Glutes", "Quads", "Adductors"], "BEGINNER", "athlete steps sideways into a lunge then returns center"),
  demo("Curtsy Lunges", "A diagonal lunge that emphasizes glute control.", ["Step one leg diagonally behind.", "Lower with front knee tracking forward.", "Drive back to standing and switch sides."], ["Glutes", "Quads"], "INTERMEDIATE", "leg crosses diagonally behind into a curtsy lunge and returns"),
  ...
  demo("Single-leg Glute Bridges", "A one-leg bridge for stronger glute focus.", ["Lie on your back with one knee bent.", "Lift the other leg off the floor.", "Drive through the planted heel to lift hips."], ["Glutes", "Hamstrings", "Core"], "INTERMEDIATE", "one leg stays raised while hips bridge up and lower"),
  ...
  demo("Dumbbell Squats", "A squat while holding dumbbells at your sides.", ["Hold dumbbells at your sides.", "Squat down with chest tall.", "Stand by pushing through your feet."], ["Quads", "Glutes"], "BEGINNER", "dumbbells hang at sides while athlete squats and stands"),
  demo("Dumbbell Reverse Lunges", "A weighted reverse lunge for legs and glutes.", ["Hold dumbbells at your sides.", "Step backward into a lunge.", "Drive through the front foot to return."], ["Quads", "Glutes", "Hamstrings"], "INTERMEDIATE", "dumbbells stay at sides while athlete steps back into lunge"),
  demo("Dumbbell Step-ups", "A weighted step-up for single-leg strength.", ["Hold dumbbells at your sides.", "Place one foot fully on a step.", "Drive up and step down with control."], ["Quads", "Glutes"], "INTERMEDIATE", "athlete steps onto box holding dumbbells then lowers"),
  ...
  demo("Hamstring Walkouts", "A bridge variation that challenges hamstrings.", ["Start in a glute bridge.", "Walk heels away one small step at a time.", "Walk heels back in while hips stay lifted."], ["Hamstrings", "Glutes"], "INTERMEDIATE", "bridge position with heels walking out and back in"),
  demo("Frog Pumps", "A glute bridge variation with soles together.", ["Lie back with soles of feet together.", "Let knees open outward.", "Drive hips up and squeeze glutes."], ["Glutes"], "BEGINNER", "knees open with soles together while hips pump upward"),
  demo("Donkey Kicks", "A quadruped glute kickback.", ["Start on hands and knees.", "Kick one heel upward with knee bent.", "Lower with control and switch sides."], ["Glutes", "Hamstrings"], "BEGINNER", "hands and knees position with one bent leg kicking upward"),
  demo("Fire Hydrants", "A quadruped side lift for glutes and hips.", ["Start on hands and knees.", "Lift one bent knee out to the side.", "Lower slowly without twisting."], ["Glutes", "Hips"], "BEGINNER", "hands and knees position with one knee lifting sideways"),
  ...
  demo("Side Plank", "A side-body plank hold for obliques.", ["Stack elbow under shoulder.", "Lift hips so body forms a straight line.", "Hold while breathing steadily."], ["Obliques", "Core", "Shoulders"], "BEGINNER", "athlete holds a straight side plank on one forearm"),
  ...
  demo("Heel Taps", "A beginner oblique move reaching side to side.", ["Lie on your back with knees bent.", "Lift shoulders slightly.", "Reach one hand toward the same-side heel and switch."], ["Obliques", "Abs"], "BEGINNER", "shoulders lifted while hands reach side to side toward heels"),
  demo("Flutter Kicks", "A lower-core drill with alternating leg kicks.", ["Lie on your back with legs long.", "Lift feet slightly from the floor.", "Kick legs up and down in small controlled motions."], ["Lower Abs", "Hip Flexors"], "INTERMEDIATE", "straight legs alternate small kicks above the floor"),
